...
from crop_fields 
from form_alignment import form_alignment
from crop_bbox import crop_bbox
from char_detection import char_detection
...
def main():
    ...
    # This last step will generate a csv file with the RGB 
