...
def crop(image, json_file):
    ...
    for field in json_file['fields']:
        ...
        if cropped_img is not None:
            ...
            print("this is the first", old_path[:-12])
            print("this is the second", old_path[93:])
